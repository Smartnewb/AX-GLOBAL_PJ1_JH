...
export const translations: Record<Locale, Translations> = {
    ...
    en: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Your data is never stored" },
    },
    // ─── 한국어 ───
    ko: {
        ...
        result: { placeholder: "분석 결과가 여기에 표시됩니다", placeholderSub: "왼쪽에서 메모를 업로드하고 'AI로 정리하기'를 클릭하세요", heading: "분석 결과", copy: "복사", copied: "복사됨", aiAnalyzing: "AI가 메모를 분석하고 있어요...", summary: "요약/번역", actionItems: "실행할 일", keyNotes: "원문(전사)" },
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "데이터를 저장하지 않습니다" },
    },
    // ─── 日本語 ───
    ja: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "データは保存されません" },
    },
    // ─── 中文 ───
    zh: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "您的数据不会被存储" },
    },
    // ─── Español ───
    es: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Tus datos nunca se almacenan" },
    },
    // ─── Tiếng Việt ───
    vi: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Dữ liệu của bạn không bao giờ được lưu" },
    },
    // ─── ภาษาไทย ───
    th: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "ข้อมูลของคุณจะไม่ถูกจัดเก็บ" },
    },
    // ─── Deutsch (Schweiz) ───
    de: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Ihre Daten werden nie gespeichert" },
    },
    // ─── Français ───
    fr: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Vos données ne sont jamais stockées" },
    },
    // ─── Português ───
    pt: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Seus dados nunca são armazenados" },
    },
    // ─── العربية ───
    ar: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "بياناتك لا تُخزّن أبدًا" },
    },
    // ─── हिन्दी ───
    hi: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "आपका डेटा कभी सहेजा नहीं जाता" },
    },
    // ─── Bahasa Indonesia ───
    id: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Data Anda tidak pernah disimpan" },
    },
    // ─── Русский ───
    ru: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Ваши данные никогда не сохраняются" },
    },
    // ─── Türkçe ───
    tr: {
        ...
        footer: { copyright: "© 2026 Mezmo Change · Powered by Gemini", dataNotStored: "Verileriniz asla saklanmaz" },
    },
};
